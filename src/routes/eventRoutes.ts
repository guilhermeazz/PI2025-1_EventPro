...
// Aplica o middleware para todas as rotas neste router
 ...
 *                   additionalInfo: { type: string, example: 'Próximo à estação de metrô' }
 *               capacity:
 *                 type: object
 *                 required:
 *                   - max
 ...
 *                   - end
 *                 properties:
 *                   start: { type: string, format: date-time, example: '2025-12-01T09:00:00Z' }
 *                   end: { type: string, format: date-time, example: '2025-12-01T17:00:00Z' }
 *               type:
 *                 type: string
 ...
 *                     type: { type: string, enum: [full, half, free, promotional, vip, other], example: 'full' }
 ...
 *                   - courseDescription
 *                 properties:
 *                   templateName: { type: string, example: 'Template Certificado Padrão' }
 *                   courseName: { type: string, example: 'Introdução à Programação' }
 *                   courseDescription: { type: string, example: 'Curso intensivo de fundamentos de programação.' }
 *               contents:
 *                 type: array
 *                 items:
 *                   type: object
 ...
 *                     - title
 *                   properties:
 *                     title: { type: string, example: 'Palestra de Abertura' }
 *               organizers:
 *                 type: array
 *                 items:
 *                   type: object
 ...
 *                     - nivel
 *                   properties:
 *                     userId: { type: string, example: '60c8e23f1f7d5c001f3e0123' }
 *                     nivel: { type: string, enum: [admin, reception, speaker], example: 'reception' }
 *               reviews:
 *                 type: array
 *                 items:
 *                   type: object
 ...
 *                     - comment
 *                   properties:
 *                     userId: { type: string, example: '60c8e23f1f7d5c001f3e0124' }
 *                     rating: { type: number, format: float, example: 4.5 }
 *                     comment: { type: string, example: 'Ótimo evento, muito bem organizado!' }
 *     responses:
 ...
 *       401: { description: 'Não autorizado (token ausente ou inválido).' }
 *       500: { description: 'Erro ao obter eventos.' }
 */
 ...
 *     responses:
 *       200: { description: 'Evento retornado com sucesso.' }
 *       401: { description: 'Não autorizado (token ausente ou inválido).' }
 *       404: { description: 'Evento não encontrado.' }
 *       500: { description: 'Erro ao obter evento.' }
 */
 ...
 *     responses:
 *       200: { description: 'Entrada validada com sucesso!.' }
 *       400: { description: 'Ingresso/código inválido, já usado ou status incorreto.' }
 *       401: { description: 'Não autorizado (token ausente ou inválido).' }
 *       404: { description: 'Evento ou Inscrição/Participação não encontrado.' }
 *       500: { description: 'Erro interno ao validar entrada.' }
 */
 ...
 *       400: { description: 'Ingresso/código inválido, não fez entrada ou status incorreto.' }
 *       401: { description: 'Não autorizado (token ausente ou inválido).' }
 *       404: { description: 'Evento ou Inscrição/Participação não encontrado.' }
 *       500: { description: 'Erro interno ao validar saída.' }
 */
